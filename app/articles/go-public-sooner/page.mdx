...
export const article = {
  ...
  date: '2024-06-24',
  title: "Go Public Sooner",
  description:
    "Takeaways from Coatue's 2024 EMW Conference. Companies are waiting longer to go public, but this trend may not be in the best interest of the company or its investors.",
}
