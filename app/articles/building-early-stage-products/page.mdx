...
should not ship every single feature users request, and Linear's MVP post covers
that, but collecting all feedback lets you make actionable product decisions and
connect with users who need help, building their trust in your team.
