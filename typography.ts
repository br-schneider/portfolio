  ...
  return {
    ...
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links-hover': theme('colors.neutral.700'),
        '--tw-prose-underline': theme('colors.neutral.400 / 0.3'),
        '--tw-prose-underline-hover': theme('colors.neutral.900'),
        ...
        '--tw-prose-invert-links': theme('colors.neutral.200'),
        '--tw-prose-invert-links-hover': theme('colors.neutral.400'),
        '--tw-prose-invert-underline': theme('colors.neutral.500 / 0.3'),
        '--tw-prose-invert-underline-hover': theme('colors.neutral.200'),
        ...
        '--tw-prose-invert-code-bg': theme('colors.neutral.800'),
